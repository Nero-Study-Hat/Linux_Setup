...
class Executor {
    ...
    static exec(command, callback, cwd, addToProcessList) {
        ...
        const childProcess = (0, child_process_1.exec)(this.handleWindowsEncoding(command), { encoding: "utf8", maxBuffer: 5120000, cwd }, callback);
        if (addToProcessList) {
...
Executor.terminals = {};
Executor.isWindows = (0, os_1.platform)() === "win32";
Executor.processes = [];
