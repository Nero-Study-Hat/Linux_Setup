...
class TestCommands {
    ...
    discoverTestsInFolder(dir) {
        return __awaiter(this, void 0, void 0, function* () {
            const testsForDir = yield (0, testDiscovery_1.discoverTests)(dir, utility_1.Utility.additionalArgumentsOption);
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                for (const file of files) {
                    const testResults = yield (0, testResultsFile_1.parseResults)(file);
