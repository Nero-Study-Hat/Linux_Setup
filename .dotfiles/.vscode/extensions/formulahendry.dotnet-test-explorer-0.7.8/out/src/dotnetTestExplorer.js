...
class DotnetTestExplorer {
    ...
    getTreeItem(element) {
        ...
        // }
        const treeItem = new vscode_1.TreeItem(element.name, element.isFolder ? utility_1.Utility.defaultCollapsibleState : void 0);
    ...
    getChildren(element) {
        ...
        let tree = (0, buildTree_1.buildTree)(parsedTestNames);
        if (treeMode === "merged") {
            tree = (0, buildTree_1.mergeSingleItemTrees)(tree);
        }
        this.testNodes = [];
